...
class ParseHandle(object):
    def list_parse(self, companies):
        ...
        for company in companies:
            ...
            item['detail_formdata'] = dict(get_base_post_paramaters('detail_formdata'), **ccp)
            #item['czxx_formdata'] = dict(get_base_post_paramaters('czxx_formdata'), **ccp)
            #item['ryxx_formdata'] = dict(get_base_post_paramaters('ryxx_formdata'), **ccp)
            #item['bgxx_formdata'] = dict(get_base_post_paramaters('bgxx_formdata'), **ccp)
            items.append(item)
